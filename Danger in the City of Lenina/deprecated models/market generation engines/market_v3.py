# V3 of the Market Creator - Final?
        ...
        for t in range(1, n_periods + 1):
            ...
            if a_it > 0 and not is_ruined:
                ...
                if transaction_cost > a_it:
                    ...
                    if (w_base[i] >= 45.0 or effective_alpha[i] >= 0.60) and dsi_ratio <= max_dsi_formal:
                    ...
                    new_loan = shortfall
                    # Cumulative debt state carries forward
                    prior_loan = prior_loan + new_loan
                    current_savings = max(0.0, a_it + new_loan - transaction_cost)
                else:
                    new_loan_type = 'None'
                    new_loan = 0.0
                    # Repay debt service and carry forward residual savings
